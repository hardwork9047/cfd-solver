...
class PlanePoiseuille:
    ...
    def numerical_solution(self, tol=1e-6, max_iter=20000, omega=1.5):
        ...
        for iteration in range(max_iter):
            ...
            if residual < tol:
                logger.info(
                    f"Converged in {iteration+1} iterations. Final residual: {residual:.2e}"
                )
                return u
    ...
    def plot(self):
        ...
        plt.plot(u_numerical, self.y, "ro", markersize=4, markerfacecolor="none", label="Numerical")
...
class CircularPoiseuille:
    ...
    def plot(self):
        ...
        ax1.plot(self.r, u_numerical, "ro", markersize=4, markerfacecolor="none", label="Numerical")
