...
def plot_comparison(cavity_low, cavity_mid):
    ...
    # Re=10 の速度
    im1 = axes[0, 0].contourf(cavity_low.X, cavity_low.Y, 
    ...
    # Re=100 の速度
    im2 = axes[0, 1].contourf(cavity_mid.X, cavity_mid.Y,
    ...
    # Re=10 の流線
    axes[1, 0].streamplot(cavity_low.X, cavity_low.Y, 
                         cavity_low.u, cavity_low.v,
                         color='steelblue', density=1.5)
    axes[1, 0].set_title('Streamlines (Re=10)', fontsize=12, fontweight='bold')
    axes[1, 0].set_aspect('equal')
    
    # Re=100 の流線
    axes[1, 1].streamplot(cavity_mid.X, cavity_mid.Y,
                         cavity_mid.u, cavity_mid.v,
                         color='steelblue', density=1.5)
